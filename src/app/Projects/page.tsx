...
const ProjectPage = () => {
  return (
    <div className="pt-20 md:pt-28 xl:pb-20">
      <div className=" flex flex-col items-center xl:gap-8  ">
        ...
        <div className="md:flex md:flex-wrap md:items-center md:pl-10 md:w-full xl:full lg:pl-48 xl:gap-12">
          <div className="flex flex-col    m-4 w-72 h-96  px-6  lg:w-2/5 xl:gap-5 xl:mb-20 ">
            ...
            <div className="flex flex-col gap-2 bg-green-200 py-2 px-4 ">
              ...
              <p className="text-sm  xl:text-lg">
                ...
                Dashboard. Monitor key metrics, track trends, and gain insights
                at a glance. A user-friendly interface puts the information you
          ...
          <div className="flex flex-col    m-4 w-72 h-96 px-6 lg:w-2/5 ">
            ...
            <div className="flex flex-col gap-2 bg-green-200 py-2 px-4 ">
              ...
              <p className="text-sm  xl:text-lg">
                ...
                familiar features, connect with friends, share updates, and
                engage with content—all within a faithful recreation of the
                well-loved social experience. Immerse yourself in nostalgia.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col     m-4 w-72 h-96 px-4  lg:w-2/5">
            ...
            <div className="flex flex-col gap-2 bg-green-200 px-2 py-5 ">
              ...
              <p className="text-sm  xl:text-lg">
                ...
                organization with user-friendly tools designed to simplify
                complex processes.
              </p>
            </div>
          </div>
          ...
          {/* 6 */}
          <div className="flex flex-col    m-4 w-72 h-96 px-6  lg:w-2/5">
            <div className="w-full h-full relative flex xl:pb-60 ">
              <Image alt="" src="/medical.png" fill className="object-cover" />
            </div>
            <div className="flex flex-col gap-2 bg-green-200  px-2  py-5">
              <h2 className="text-xl md:text-2xl md:font-medium">
                Charity (ORG)
